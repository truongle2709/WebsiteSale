...
namespace WebApplication1.Areas.Admin.Controllers
{
    public class TaiKhoanController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Username,Password,Email,Phone,Address,Fullname,isAdmin")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Username,Password,Email,Phone,Address,Fullname,isAdmin")] Account account)
        {
            if (ModelState.IsValid)
            {
